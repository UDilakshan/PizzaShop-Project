/* This is the container which contains the RowContainer(for Displaying Categories info) */
...
const CategoryContainer = () => {
  ...
  return (
        <section className='w-full mt-8 md:mt-24 h-auto'>
            ...
            <RowContainer flag={false} data={foodItems?.filter(n => n.category ==="Category Data")}/>
         </section>
  )
}
